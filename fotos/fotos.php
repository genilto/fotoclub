...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="90" height="54"><a href="index.php"><img src="<? echo $end_objetos; ?>arquivos/images/usuarios_01.gif" alt="<? echo $url_site; ?>" width="90" height="54" border="0"></a></td>
    <td width="660" height="54" background="<? echo $end_objetos; ?>arquivos/images/usuarios_02.gif"><? include "menu_cima_fotos_site.php"; ?></td>
  </tr>
</table>
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="750" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="<? echo $cor_lados; ?>">
        ...
        <tr> 
          ...
          <td height="500" valign="top" bgcolor="<? echo $cor_meio; ?>"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td align="center"><font size="2" color="<? echo $cor_tit; ?>" face="<? echo $fonte_tit; ?>"><strong>Fotos 
        ...
        $ssql = "SELECT * FROM fotos WHERE user = '".$nome."'";
        ...
        $sql_list = "
            SELECT * FROM fotos WHERE user = '".$nome."' ORDER BY id DESC LIMIT ".$inicio.",".$TAMANHO_PAGINA."";
        ...
        while(($reg = mysqli_fetch_array($res_list))){
            $total_registros++;
?>
                      <td align="center" valign="bottom" class="texto"> <a href="usuarios.php?nome=<? echo $nome; ?>&foto=<? echo $reg["id"]; ?>"> 
                        <img src="<? echo $nome."/thumbs/".$reg["thumb"]; ?>" alt="<? echo $reg["data"]; ?>" border="0" class="img"> 
                        </a><br>
                        <font color="<? echo $cor_comentario; ?>"><? echo $reg["data"]; ?></font> 
                        <br>
                        <br>
						<br>
						<br>
  ...
  ?>
                      ...
                      <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td width="34%" align="right" class="texto_gran"><font color="<? echo $cor_comentario; ?>">Total: 
                              <? echo $num_total_registros; ?> foto(s).</font></td>
                          </tr>
                        </table></td>
                    </tr>
                    <?
		...
		?>
                    ...
                    <tr> 
                      <td align="center" class="titulo"><font color="<? echo $cor_comentario; ?>">Nenhuma foto foi encontrada!</font></td>
                    </tr>
                    <tr> 
                      <? }
?>
