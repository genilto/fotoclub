function select_color(local_retorno){
	var conteudo = 	new String(
					"<html STYLE='width: 238px; height: 187px'><head><title>Selecione a cor</title>\n							"+
					...
					"		}else{\n																							"+
					"			View(color);\n																					"+
					"			window.opener." + local_retorno + ".value = color;\n											"+
					"			window.opener.carrega_cores();\n																"+
					"			window.opener.carrega_titulo();\n																"+
					"			window.opener.carrega_comentario();\n															"+
					"			window.opener.focus();\n																		"+
					"			window.close();\n																				"+
					"		}\n																									"+
					"	}\n																										"+
					...
					"		</td>\n																								"+
				   	"		<td bgcolor=\"buttonface\" valign=center>\n															"+	
				   	"			<input type=\"text\" name=\"ColorHex\" value=\"\" size=15 style=\"font-size: 12px\">\n			"+
				   	"		</td>\n																								"+
	...
	var abre_janela = window.open("", "Cores", "width=229,height=164,status=no,resizable=yes,top=350,left=400");
	abre_janela.opener = self;
	var documento = abre_janela.document;
